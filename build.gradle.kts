...
val mvnArtifactId = "thread-utils-jvm" // see settings.gradle.kts
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = mvnArtifactId
                description = "Utilities for using threads"
                url = "https://github.com/wcarmon/thread-utils-jvm"

                licenses {
                    license {
                        name = "MIT License"
                        url =
                            "https://raw.githubusercontent.com/wcarmon/thread-utils-jvm/main/LICENSE"
                    }
                }
                ...
                scm {
                    connection =
                        "scm:git:git@github.com:wcarmon/thread-utils-jvm.git"
                    developerConnection =
                        "scm:git:ssh://github.com:wcarmon/thread-utils-jvm.git"
                    url = "https://github.com/wcarmon/thread-utils-jvm/tree/main"
                }
            }
        }
    }
